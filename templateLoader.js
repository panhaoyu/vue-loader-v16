...
const TemplateLoader = function (source, inMap) {
    ...
    const compiled = compiler_sfc_1.compileTemplate({
        ...
        compiler,
        compilerOptions: Object.assign(Object.assign({}, options.compilerOptions), { scopeId, bindingMetadata: typeof query.bindings === 'string' && query.bindings !== 'undefined'
                ? JSON.parse(query.bindings)
                : {} }),
